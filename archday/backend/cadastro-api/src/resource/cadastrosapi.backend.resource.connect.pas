unit cadastrosapi.backend.resource.connect;
...
begin
  ...
  FConnList.Items[IndexConn].Params.Add('MetaCurSchema=cadastros');
  FConnList.Items[IndexConn].Params.Add('MetaDefSchema=cadastros');
  {$ELSE}
