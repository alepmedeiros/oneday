unit autenticacaoapi.backend.resource.connect;
...
begin
  ...
  try
    ...
    FConnList.Items[IndexConn].Params.Add('MetaCurSchema=autenticacao');
    FConnList.Items[IndexConn].Params.Add('MetaDefSchema=autenticacao');
    FConnList.Items[IndexConn].ExecSQL('ALTER DATABASE dados SET search_path TO public, autenticacao, cadastros, vendas');
    {$ELSE}
